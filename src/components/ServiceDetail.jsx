...
export default function ServiceDetail({ serviceName, onBack, onContact }) {
  const service = servicesData.find((s) => s.key === serviceName)
    ...
    <main style={{ paddingTop: '80px' }}>
      ...
      <div style={{ backgroundColor: '#002775', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center gap-2">
          ...
          <span className="font-inter text-xs" style={{ color: '#FFFFFF' }}>{service.key}</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              ...
              >
                ...
                <p className="font-montserrat font-bold text-white text-lg mb-2">{service.key}</p>
      ...
      <section className="py-16" style={{ backgroundColor: '#F5F7FA' }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            >
              Key Features of Our {service.key} Service
            </h2>
          </div>
      ...
      <section className="hero-pattern py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          >
            Ready to Optimize Your {service.key}?
          </h2>
